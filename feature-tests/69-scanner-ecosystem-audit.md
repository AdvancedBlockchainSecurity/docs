...
| 12 | UI path via Traefik | Pass | https://app.0xapogee.com/api/v1/scanners returns updated URL |
...
curl -sk https://app.0xapogee.com/api/v1/scanners | jq '.scanners | length'
curl -sk https://app.0xapogee.com/api/v1/scanners | jq '[.scanners[].id] | sort'

# RustDefend URL
curl -sk https://app.0xapogee.com/api/v1/scanners | jq '.scanners[] | select(.id=="rustdefend") | .github_url'
