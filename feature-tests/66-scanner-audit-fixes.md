...
curl -sk https://app.0xapogee.com/api/v1/vulnerabilities?scanner_id=solhint | jq '.total'
# Should be > 0
...
curl -sk https://app.0xapogee.com/api/v1/vulnerabilities?scanner_id=vyper | jq '.total'
...
curl -sk https://app.0xapogee.com/api/v1/vulnerabilities?limit=5 | jq '.items[0].code_snippet'
