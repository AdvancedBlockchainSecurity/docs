...
**Note:** As of Dashboard v0.39.0, the Retrain Model button has been removed from the user dashboard. Retraining is now admin-only via the Admin Portal at `admin.0xapogee.com/ml-models`.
