...
curl -s http://app.0xapogee.com/api/v1/contracts \
...
for i in $(seq 1 15); do
  curl -s -o /dev/null -w "%{http_code}" \
    ...
    http://app.0xapogee.com/api/v1/auth/wallet/nonce \
    -H "Content-Type: application/json" \
...
curl -s -X POST http://app.0xapogee.com/api/v1/notification-channels \
...
curl -s http://app.0xapogee.com/api/v1/quality-gates/00000000-0000-0000-0000-000000000000 \
  -H "Authorization: Bearer $TOKEN"
...
curl -s http://app.0xapogee.com/api/v1/copilot/conversations \
