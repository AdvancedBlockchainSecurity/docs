...
**Cause:** Supabase Site URL points to wrong address (e.g., `http://127.0.0.1:3000` instead of `http://app.0xapogee.com`).
...
2. Set **Site URL** to `http://app.0xapogee.com`
3. Add `http://app.0xapogee.com/**` to **Redirect URLs**
