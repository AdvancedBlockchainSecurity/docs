...
```bash
curl -X POST https://api.0xapogee.com/api/v1/invariants/generate \
...
```bash
curl -X GET "https://api.0xapogee.com/api/v1/invariants/templates?category=reentrancy" \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -X GET https://api.0xapogee.com/api/v1/invariants/quota \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -X GET https://api.0xapogee.com/api/v1/invariants/inv_7f3a2b1c-4d5e-6f7a-8b9c-0d1e2f3a4b5c \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -X GET "https://api.0xapogee.com/api/v1/invariants/contract/c961ca39-c568-4245-aa95-497d34b20c28?type=reentrancy" \
  -H "Authorization: Bearer $TOKEN"
```
