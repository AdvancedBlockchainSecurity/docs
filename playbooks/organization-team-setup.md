...
- [ ] Access to Apogee API at `https://app.0xapogee.com/api/v1`
...
```bash
curl -X GET "https://app.0xapogee.com/api/v1/organizations/{org_id}/roles" \
  -H "Authorization: Bearer $ACCESS_TOKEN"
```
...
```bash
curl -X POST "https://app.0xapogee.com/api/v1/organizations/current/users" \
  -H "Authorization: Bearer $ACCESS_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
# Get team members
TEAM_MEMBERS=$(curl -s "https://app.0xapogee.com/api/v1/teams/{team_id}/members" \
...
```bash
curl -X DELETE "https://app.0xapogee.com/api/v1/organizations/{org_id}/members/{user_id}" \
  -H "Authorization: Bearer $ACCESS_TOKEN"
```
...
```bash
curl -X DELETE "https://app.0xapogee.com/api/v1/projects/{project_id}/access/{user_id}" \
  -H "Authorization: Bearer $ACCESS_TOKEN"
```
...
```bash
curl -X DELETE "https://app.0xapogee.com/api/v1/teams/{team_id}" \
  -H "Authorization: Bearer $ACCESS_TOKEN"
```
...
```bash
curl -X DELETE "https://app.0xapogee.com/api/v1/organizations/{org_id}" \
  -H "Authorization: Bearer $ACCESS_TOKEN"
```
