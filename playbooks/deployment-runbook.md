...
# 2. Auto-sync kustomization newTag (using shared script)
/home/pwner/Git/blocksecops-shared/scripts/docker/sync-version.sh .

# 3. Apply kustomization (updates Deployment + CronJob)
...
curl -sk https://app.0xapogee.com/api/v1/health/live | python3 -c \
