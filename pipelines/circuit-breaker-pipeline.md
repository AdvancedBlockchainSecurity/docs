...
Frontend circuit breaker implementation for the admin portal (`admin.0xapogee.com`), mirroring the backend `circuit_breaker.py` pattern for resilient API communication.
