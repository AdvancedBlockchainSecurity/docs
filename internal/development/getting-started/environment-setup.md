...
mkdir -p ~/blocksecops-platform
cd ~/blocksecops-platform

# Clone all service repositories
git clone <api-service-url> blocksecops-api-service
git clone <tool-integration-url> blocksecops-tool-integration
git clone <intelligence-engine-url> blocksecops-intelligence-engine
git clone <orchestration-url> blocksecops-orchestration
git clone <data-service-url> blocksecops-data-service
git clone <notification-url> blocksecops-notification
git clone <dashboard-url> blocksecops-dashboard
git clone <findings-url> blocksecops-findings
git clone <analysis-url> blocksecops-analysis
git clone <parser-url> blocksecops-contract-parser
git clone <shared-library-url> blocksecops-shared
```
...
DATABASE_URL="postgresql://user:pass@localhost/blocksecops"
...
node -e "const { Vulnerability } = require('@blocksecops/shared'); console.log('TypeScript OK')"
...
pip install -e ../blocksecops-shared/python
```
