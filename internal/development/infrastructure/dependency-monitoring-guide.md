...
The dependency monitoring service is located in the `blocksecops-monitoring` repository following the standard Kubernetes Kustomize structure:
...
- blocksecops-shared (Rust components)
...
cd /Users/pwner/Git/ABS/blocksecops-monitoring
...
docker run -p 8000:8000 \
  ...
  blocksecops-dependency-monitor:latest
```
