...
Environment Version: Development v2.4

## ⚠️ Important: Traefik Routing Requirement

**All Dashboard and API traffic MUST go through Traefik ingress controller.**

```bash
# CORRECT: Port-forward to Traefik
kubectl port-forward -n traefik-local svc/traefik 3000:80

# This routes:
# - http://127.0.0.1:3000/ → Dashboard
# - http://127.0.0.1:3000/api/v1/* → API Service
```

See [Production Parity Principle](/Users/pwner/Git/ABS/docs/standards/dashboard-development.md) for details.