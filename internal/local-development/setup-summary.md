...
- **URL**: `localhost:5000`
- **Status**: ✅ Running and verified
- **Images**: blocksecops-api-service:dev

## Application Services

### Shared Library Resolution ✅
- **Type**: Pure Python package (Rust bindings excluded for simplicity)
- **Package**: `blocksecops_shared-0.1.0-py3-none-any.whl`
...
blocksecops    # Application services (when deployed)
...
> All traffic to Dashboard and API must go through Traefik ingress controller.
> Direct port-forwarding to individual services breaks API routing.

```bash
# ✅ CORRECT: Port-forward to Traefik (routes both Dashboard and API)
kubectl port-forward -n traefik-local svc/traefik 3000:80

# This provides:
# - Dashboard at http://127.0.0.1:3000/
# - API at http://127.0.0.1:3000/api/v1/*

# ❌ WRONG: Do NOT port-forward directly to services
...
# Grafana monitoring (standalone, no Traefik routing needed)
kubectl port-forward svc/monitoring-grafana 3001:80 -n monitoring
```

See `/Users/pwner/Git/ABS/docs/standards/dashboard-development.md` for detailed routing standards.
...
**Last Updated**: November 30, 2025 (Traefik routing requirements)
