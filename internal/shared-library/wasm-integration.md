...
### Automatic Loading
```typescript
import { generateContractId, isWasmAvailable } from 'blocksecops-shared';
...
```typescript
import { ensureWasmLoaded, getWasmError } from 'blocksecops-shared';
...
```typescript
import { getWasmError, getWasmDiagnostics } from 'blocksecops-shared';
...
1. **Install updated package**: `npm install blocksecops-shared@latest`
